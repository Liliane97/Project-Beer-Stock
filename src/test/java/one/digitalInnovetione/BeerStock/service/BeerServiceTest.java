package one.digitalInnovetione.BeerStock.service;

import one.digitalInnovetione.BeerStock.builder.BeerDTOBuilder;
...
//        assertThat(createdBeerDTO.getQuantity(), is(greaterThan(2)));//testando se a quantidade é maior que 2

    }

    @Test
    void whenAlreadyRegisterBeerInformedThenAnExceptionShouldBeThrows() {
        //give
        BeerDTO expectedBeerDTO = BeerDTOBuilder
                .builder()
                .build().toBeerDTO();
    ...
    void whenValidBeerNameIsGivenThenReturnABeer() throws BeerNotFoundException {
        //give
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder
                .builder()
                .build()
                .toBeerDTO();
    ...
    @Test
    void whenListBeerCalledThenReturnAnEmptyListOfBeers(){
        //when
    ...
    @Test
    void  whenDecrementIsCalledToEmptyStockThenEmptyThenBeerStock() throws  BeerNotFoundException,BeerStockExceededException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenDecrementIsCalledIsCalledWithInvalidThenThrowException() {
        int quantityToDecrement = 10;
