package one.digitalInnovetione.BeerStock.controller;

import one.digitalInnovetione.BeerStock.builder.BeerDTOBuilder;
import one.digitalInnovetione.BeerStock.controllers.BeerController;
...
import static one.digitalInnovetione.BeerStock.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    @Test
    void whenPOSTIsCallThenABeerIsCreated() throws Exception {
        //give
        BeerDTO beerDTO = BeerDTOBuilder
                .builder().build().toBeerDTO();
    ...
    @Test
    void whenPATCHIsCalledToDecrementLowerThenZeroThenBadRequestStatusIsReturned() throws  Exception {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(60)
                .build();
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
